...
const prompt = ai.definePrompt({
  ...
  4.  Fair Work: A clean, polished, notebook-ready version of the explanation. It should be written in clear, complete sentences and well-formed paragraphs, not as a list of bullet points. This is the 'final answer' that a student would copy into their notes after understanding the concept.
